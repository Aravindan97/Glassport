...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="glasses.jpg" width="1200" height="700">
      ...
      <div class="item">
        <img src="rayban.jpg" alt="Chicago" width="1200" height="700">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="sunglasses.jpg" alt="Los Angeles" width="1200" height="700">
        <div class="carousel-caption">
          <h3>Sun Glasses</h3>
    ...
    <a class="left carousel-control" href="/GlassPort/FILE15712.JPG" role="button" data-slide="prev">
      <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
      <span class="sr-only">Previous</span>
    </a>
    <a class="right carousel-control" href="/GlassPort/FILE15712.JPG" role="button" data-slide="next">
...
<div id="band" class="container text-center">
  ...
  <p>Wow customers by doing something that has never been done before in the eyewear industry. It began with an aim. An aim to provide every Indian access to high-quality designer glasses without shelling out their pocket. We rocked our brains. We broke our backs to come up with a plan that will not just change the way this industry works, but also will completely sweep customer off their feet. It can only be achieved if we provide.</p>
  <br>
    <div class="col-sm-4-center">
      <p class="text-center"><strong>Aravindan</strong></p><br>
      <a href="#demo2" data-toggle="collapse">
        <img src="throne.jpg" class="img-circle person" alt="Random Name" width="70" height="70">
      </a>
...
<div id="tour" class="bg-1">
  <div class="container">
    ...
    <div class="row text-center">
      <div class="col-sm-4">
        <div class="thumbnail">
          <img src="glasses.jpg" width="400" height="300">
          <p><strong>Power Glass</strong></p>
          <p>Starting from Rs.900</p>
          <button class="btn" data-toggle="modal" data-target="/GlassPort/FILE15712.JPG">Buy This</button>
        </div>
      </div>	
      <div class="col-sm-4">
        <div class="thumbnail">
          <img src="rayban.jpg" alt="New York" width="400" height="300">
          <p><strong>Nerd Glass</strong></p>
          <p>Starting from Rs.2900</p>
          <button class="btn" data-toggle="modal" data-target="#">Buy This</button>
        </div>
      </div>
      <div class="col-sm-4">
        <div class="thumbnail">
          <img src="sunglasses.jpg" alt="San Francisco" width="400" height="300">
